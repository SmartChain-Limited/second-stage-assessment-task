...
import { Input, Select } from "../../ui/utils/Input";
import Button from "../../ui/utils/Button";
import useForm3 from "../hooks/useForm3";

const Form3 = ({ next }: { next: (prev: number) => void }) => {
  const {
    form,
    errors,
    specialization,
    ...
    <div className="flex flex-col gap-[24px]">
      <div className="flex flex-col gap-[24px] min-h-[374px]">
        <Input
          ...
          placeholder="University  (e.g. Mountain Dew University, Enugu)"
        ...
        <div className="flex sm:flex-row flex-col gap-3 items-center">
          ...
          <Input
            name="gaduation_date"
            value={form.gaduation_date}
            placeholder="Graduation date"
            error={errors.gaduation_date}
            handleChange={handleChange}
            type="date"
          />
        </div>
