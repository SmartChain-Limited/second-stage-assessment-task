...
//             className={`mx-2 h-[12px] w-[12px] rounded-full border border-[#3C6AAC] md:w-[23px] md:h-[23px] text-center text-[#fff] text-[11px] ${
//               currentPage >= index + 1 ? "bg-[#3C6AAC]" : ""
//             }`}
//           >
//             {index + 1}
//           </div>
...
//                 <hr className="w-[190px] border border-b-[#3C6AAC]" />
//               )}
//               {item}
//             </>
//           );
